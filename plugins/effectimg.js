...
if (Config.WORKTYPE == 'private') {
    ...
    await message.sendMessage('🇱🇰⚜️ කමාන්ඩ්: *.glitch*\n⚜️💠විස්තරය: It Sends a glitch style image of the text provided.\nYou must enter the heading and subheading seperated by */* in order!.\n\n🇱🇰⚜️ කමාන්ඩ්: *.pornhub*\n⚜️💠විස්තරය: It Sends a blackish orange coloured image of the text provided.\nYou must enter the heading and subheading seperated by */* in order!.\n\n🇱🇰⚜️ කමාන්ඩ්: *.sandwriting*\n⚜️💠විස්තරය: It Sends a sand image of the text provided.\n\n🇱🇰⚜️ කමාන්ඩ්: *.blackpink*\n⚜️💠විස්තරය: It Sends a blackish pink image of the text provided.\n\n🇱🇰⚜️ කමාන්ඩ්: *.lovemsg*\n⚜️💠විස්තරය: It Sends love message style image of the text provided.\n\n🇱🇰⚜️ කමාන්ඩ්: *.grass*\n⚜️💠විස්තරය: It Sends a grass image of the text provided.\n\n🇱🇰⚜️ කමාන්ඩ්: *.blood*\n⚜️💠විස්තරය: It Sends a blood image of the text provided.\n\n🇱🇰⚜️ කමාන්ඩ්: *.romance*\n⚜️💠විස්තරය: It Sends a green image with love shapes of the text provided.\n\n🇱🇰⚜️ කමාන්ඩ්: *.candlemug*\n⚜️💠විස්තරය: It Sends a mug image of the text provided.\n\n🇱🇰⚜️ කමාන්ඩ්: *.snow*\n⚜️💠විස්තරය: It Sends a snow image of the text provided.\n\n🇱🇰⚜️ කමාන්ඩ්: *.cloud*\n⚜️💠විස්තරය: It Sends a sky image of the text provided\n\n🇱🇰⚜️ කමාන්ඩ්: *.underwater*\n⚜️💠විස්තරය: It Sends a ocean image of the text provided\n\n🇱🇰⚜️ කමාන්ඩ්: *.flower*\n⚜️💠විස්තරය: It Sends a flower image of the text provided\n\n🇱🇰⚜️ කමාන්ඩ්: *.burn*\n⚜️💠විස්තරය: It Sends a half burned paper image of the text provided\n\n🇱🇰⚜️ කමාන්ඩ්: *.candy*\n⚜️💠විස්තරය: It Sends a candy image of the text provided\n\n🇱🇰⚜️ කමාන්ඩ්: *.wood*\n⚜️💠විස්තරය: It Sends a wood carved image of the text provided.\n\n🇱🇰⚜️ කමාන්ඩ්: *.latte*\n⚜️💠විස්තරය: It put the text as latte art within a coffee cup.\n\n🇱🇰⚜️ කමාන්ඩ්: *.8bit*\n⚜️💠විස්තරය: Converts the text into an 8bit style image.\nYou must enter the heading and subheading seperated by */* in order!\n\n🇱🇰⚜️ කමාන්ඩ්: *.shadow*\n⚜️💠විස්තරය: Converts the text into shadow themed image.\n\n🇱🇰⚜️ කමාන්ඩ්: *.harrypotter*\n⚜️💠විස්තරය: Converts the text into a harrypotter themed image.\n\n🇱🇰⚜️ කමාන්ඩ්: *.sparkling*\n⚜️💠විස්තරය: Converts the text into a sparkling themed image\nYou must enter the heading and subheading seperated by */* in order!\n\n🇱🇰⚜️ කමාන්ඩ්: *.watercolour*\n⚜️💠විස්තරය: Converts the text into a watercolour themed image.\n\n🇱🇰⚜️ කමාන්ඩ්: *.ninjalogo*\n⚜️💠විස්තරය: Enters the text as the caption for a ninja themed logo.\n\n🇱🇰⚜️ කමාන්ඩ්: *.neonlight*\n⚜️💠විස්තරය: Converts the text into a neonlight themed image.\n\n🇱🇰⚜️ කමාන්ඩ්: *.3dtext*\n⚜️💠විස්තරය: Converts the provided text into a 3D style image.');
